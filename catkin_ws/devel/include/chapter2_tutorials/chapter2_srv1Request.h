...
bool operator==(const ::chapter2_tutorials::chapter2_srv1Request_<ContainerAllocator1> & lhs, const ::chapter2_tutorials::chapter2_srv1Request_<ContainerAllocator2> & rhs)
{
  return lhs.A == rhs.A &&
    lhs.B == rhs.B &&
    lhs.C == rhs.C;
